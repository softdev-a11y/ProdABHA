    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<MainLayout />}>
          ...
          <Route path="/m3/search-patient" element={<SearchPatientPage />} />
          <Route path="/m3/select-records" element={<SelectRecordsPage />} />
          <Route path="/m3/request-consent" element={<RequestConsentPage />} />
          <Route
            path="/m3/pending-requests"
            element={<PendingRequestsPage />}
          />
          <Route path="/m3/view-records" element={<ViewRecordsPage />} />
        </Route>
